...
export default function GoldActiveSavings() {
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.infoboxContainer}>
          <View style={styles.inforowContainer}>
            <Text style={styles.inforowHeadingText}>DAILY SAVINGS</Text>
        ...
        <View style={styles.optionsListContainer}>
          <View style={styles.toggleOptionContainer}>
            <Text style={styles.optionText}>Daily Savings</Text>
            <Switch size="lg" />
          </View>
          ...
          <View style={styles.amountOptionContainer}>
            ...
            <View style={styles.amountOptionRightContainer}>
              <Text style={styles.amountOptionText}>Rs 100</Text>
              <ChevronRightIcon />
            </View>
          </View>
        </View>
